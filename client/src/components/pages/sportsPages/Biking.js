...
function Biking() {
  ...
  return (
    <div
      style={{
        background: "url(https://cdn.hipwallpaper.com/i/16/25/cOvFSg.jpg)",
    ...
    >
      ...
      >
        <h1 style={{ color: "white" }}>Biking Activities Page</h1>
        ...
        <div>
          <EventList activity="Biking" searched={searched} dateT={dateT} />
        </div>
      </div>
    </div>
  );
