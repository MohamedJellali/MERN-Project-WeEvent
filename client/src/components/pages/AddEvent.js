...
function AddEvent() {
  ...
  const handleAddClick = () => {
    if (verifyEmpty(formData) != 0) {
      ...
      history.push(`${formData.activity.toLocaleLowerCase()}`);
      intializeData();
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Label for="nameOfEvent" style={{ fontWeight: "bolder" }}>
            Title
          </Label>
          <input
          ...
          />
          <Label for="description" style={{ fontWeight: "bolder" }}>
            Description
          </Label>
          <Input
            ...
            style={{ height: "100px" }}
          />
          <Label for="Category" style={{ fontWeight: "bolder" }}>
            Category
          </Label>
          <Input
          ...
          <Label for="Activity" style={{ fontWeight: "bolder" }}>
            Activity
          </Label>
          <Input
          ...
          <Label for="address" style={{ fontWeight: "bolder" }}>
            Address
          </Label>
          <input
          ...
          <input
            ...
            onChange={handleFormChange}
          />
          <Label for="governorate" style={{ fontWeight: "bolder" }}>
            Governorate
          </Label>
          <Input
          ...
          <Label for="date" style={{ fontWeight: "bolder" }}>
            Date/Time
          </Label>
          <input
            value={formData.date}
