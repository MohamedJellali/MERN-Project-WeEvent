...
function Painting() {
  ...
  return (
    <div
      style={{
        background: "url(https://images.unsplash.com/photo-1461344577544-4e5dc9487184?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80)",
    ...
    >
      ...
      >
        ...
        <div>
          <EventList activity="Painting" searched={searched} dateT={dateT} />
        </div>
      </div>
    </div>
  );
