...
function Yoga() {
  ...
  return (
    <div
      style={{
        background: "url(https://images.unsplash.com/photo-1532798442725-41036acc7489?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80)",
